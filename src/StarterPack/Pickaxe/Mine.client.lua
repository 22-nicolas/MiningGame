...
local MineRequest = ReplicatedStorage:WaitForChild("Mining"):WaitForChild("MineRequest")
local StopMining = ReplicatedStorage:WaitForChild("Mining"):WaitForChild("StopMining")
local NewTarget = ReplicatedStorage:WaitForChild("Mining"):WaitForChild("NewTarget")
